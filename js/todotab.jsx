...
Icon.Settings = React.createClass({
	render: function()	{
		return (
			<svg className="Icon Icon--settings" fill="#000000" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
...
Icon.Help = React.createClass({
	render: function()	{
		return (
			<svg className="Icon Icon--help" fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				<path d="M0 0h24v24H0z" fill="none"/>
...
Icon.List = React.createClass({
	render: function()	{
		return (
			<svg className="Icon Icon--list" fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
